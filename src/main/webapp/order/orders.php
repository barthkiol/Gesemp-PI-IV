	                ...
	                <div class="row">
	                    <div class="col-lg-12">
	                        ...
	                        <div id="new" style="padding-left: 80%">
	                       		 <a href="new.php"><button type="button" class="btn btn-success">Novo Pedido</button></a>
	                        </div>
	                        <div id="tabela" style="padding-right: 70px; padding-left: 30px;"> 
			                    <script>
									...
									$(document).ready(function () {
										listar_pedido (pagina, qnt_result_pg);
									});
	
									function listar_pedido (pagina, qnt_result_pg){
										var dados = {
												pagina: pagina,
												qnt_result_pg: qnt_result_pg
										}
										
										$.post('consultar_pedido.php', dados, function(retorna){
											$("#tabela").html(retorna);
										});
									}
