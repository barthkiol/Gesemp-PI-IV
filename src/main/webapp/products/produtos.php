	            ...
	            <div class="container-fluid">
	                <div class="row">
	                    <div class="col-lg-12">
	                        ...
	                        <hr class="hr3">
	                        <div id="new" style="padding-left: 80%">
	                       		 <a href="../new/product.php"><button type="button" class="btn btn-success">Novo Produto</button></a>
	                        </div>
	                        <div id="tabela" style="padding-right: 70px; padding-left: 30px;"> 
			                    <script>
									...
									$(document).ready(function () {
										listar_produto (pagina, qnt_result_pg);
									});
	
									function listar_produto (pagina, qnt_result_pg){
										var dados = {
												pagina: pagina,
												qnt_result_pg: qnt_result_pg
										}
										
										$.post('lista_produto.php', dados, function(retorna){
											$("#tabela").html(retorna);
										});
									}
